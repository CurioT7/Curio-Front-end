function ShareIcon() {
  return (
    <svg style={{display: 'inline-block', marginRight: '5px'}} rpl="" fill="currentColor" height="20" icon-name="share-outline" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
