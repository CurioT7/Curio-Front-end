...
function Queues(){
  return(<svg style={{display: 'inline-block', marginRight: '12px', }} rpl="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" height="20" width="20" icon-name="mod-queue-fill" fill="currentColor">
