function FilledDownvote(props) {
  return (
    <svg rpl="" fill={props.colorFill ? (props.colorFill) : "#ffffff"} height="16" icon-name="downvote-fill" viewBox="0 0 20 20" width="16" xmlns="http://www.w3.org/2000/svg">
