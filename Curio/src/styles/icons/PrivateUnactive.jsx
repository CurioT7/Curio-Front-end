function PrivateUnactive() {
  return (
    <svg rpl="" fill="currentColor" height="25" icon-name="lock-outline" viewBox="0 0 20 20" width="25" xmlns="http://www.w3.org/2000/svg">
...
export default PrivateUnactive